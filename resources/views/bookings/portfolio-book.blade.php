                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <select id="category" x-model="category" name="category_id" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" required>
                                            <option value="{{ucfirst(get_categories()->where('id', $book->category_id)->first()->id)}}">{{ucfirst(get_categories()->where('id', $book->category_id)->first()->name)}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <select name="service_provider_id" id="service_provider_id" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" required>
                                            <option value="{{get_approved_service_providers()->where('id', $book->id)->first()->id}}">{{get_approved_service_providers()->where('id', $book->id)->first()->name}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-full lg:w-4/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input type="tel" name="phone" value="{{Auth::user()->phone}}" id="phone" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" maxlength="12" required>
                                    </div>
                                </div>
                                ...
                                <div class="w-full lg:w-4/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input type="email" name="email" value="{{Auth::user()->email}}" id="email" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" required>
                                    </div>
                                </div>
