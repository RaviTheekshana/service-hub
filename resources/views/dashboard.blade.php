    ...
    <div class="mt-3">
                                ...
                                <table class="bg-white min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="{{route('job.destroy', $blogs->id)}}" class="p-1 bg-white inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
        ...
        <div id="bar-with-underline-2" class="hidden" role="tabpanel" aria-labelledby="bar-with-underline-item-2">
            <div class="max-w-[50rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <form action="{{ route('job.store') }}" method="POST" enctype="multipart/form-data" x-data="{ title: '', description: '', image: null, imagePreview: '' }">
                    @csrf
                      ...
                      Created
                                    ...
                                    <tr>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            ...
                                            @endphp
                                            <a class="block" href="{{route('profile_management.show', ['profile_management' => $profiles->id])}}">
                                            <div class="px-6 py-3">
                                                <div class="flex items-center gap-x-2">
                                                    <img class="inline-block size-10 rounded-full" src="{{get_service_providers()->where('id', $books->service_provider_id)->first()->profile_photo_url}}" alt="Avatar">
                                                    <div class="grow">
                                                        <span class="text-sm text-gray-950">{{get_service_providers()->where('id', $books->service_provider_id)->first()->name}}</span>
                                                        <span class="block text-sm text-gray-500">{{get_service_providers()->where('id', $books->service_provider_id)->first()->email}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            </a>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm font-semibold text-gray-800">{{$books->description}}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                ...
                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                ...
                                                <span class="block text-sm text-gray-500">{{$books->phone_two}}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-600">{{\Carbon\Carbon::parse($books->created_at)->format('F j, Y')}}</span>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
